...
Эксплуатация и аудит нод: [docs/RUNBOOK.md](docs/RUNBOOK.md).
...
2. В **Environment variables** (**Advanced mode**) добавь переменные из [`.env.example`](.env.example) (`BOT_TOKEN`, `XUI_*`, …).
